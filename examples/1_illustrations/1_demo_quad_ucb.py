...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--fig-fname", type=str, default="2_demo_quad_ucb.pdf", help="Figure filename."
    )
    ...
    axis[0, 0].fill_between(tt, mean_ + std_, mean_ - std_, color="tab:blue", alpha=0.2)
    ...
    axis[0, 1].fill_between(tt, mean_ + std_, mean_ - std_, color="tab:blue", alpha=0.2)
