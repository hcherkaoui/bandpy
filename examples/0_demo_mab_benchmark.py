...
if __name__ == '__main__':
    ...
    bandit_env = env.GaussianKBandit(mu=mu, sigma=sigma, T=args.T,
                                     seed=args.seed)

    l_agent_kits = [
        {'agent_name': 'UCB',
         'agent_cls': agents.UCB,
         'agent_kwargs': {'delta': 0.1,
                          'K': bandit_env.K,
                          'seed': args.seed,
                          },
        },
    ...
    plt.grid()
    plt.legend(ncol=1, fontsize=fontsize, loc='center left',
